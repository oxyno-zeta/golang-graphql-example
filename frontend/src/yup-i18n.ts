...
yup.setLocale({
  mixed: {
    ...
    notOneOf: ({ values }) => ({
      key: 'common:fieldValidationError.notOneOf',
      values: { values },
    }),
    oneOf: ({ values }) => ({
      key: 'common:fieldValidationError.oneOf',
      values: { values },
    }),
  },
  array: {
    length: ({ length }) => ({
      key: 'common:fieldValidationError.array.length',
      values: { length },
    }),
    max: ({ max }) => ({
      key: 'common:fieldValidationError.array.max',
      values: { max },
    }),
    min: ({ min }) => ({
      key: 'common:fieldValidationError.array.min',
      values: { min },
    }),
  },
  boolean: {
  ...
  date: {
    max: ({ max }) => ({
      key: 'common:fieldValidationError.date.max',
      values: { max },
    }),
    min: ({ min }) => ({
      key: 'common:fieldValidationError.date.min',
      values: { min },
    }),
  },
  object: {
  ...
  string: {
    ...
    length: ({ length }) => ({
      key: 'common:fieldValidationError.string.length',
      values: { length },
    }),
    max: ({ max }) => ({
      key: 'common:fieldValidationError.string.max',
      values: { max },
    }),
    min: ({ min }) => ({
      key: 'common:fieldValidationError.string.min',
      values: { min },
    }),
    lowercase: () => ({ key: 'common:fieldValidationError.string.lowercase' }),
    uppercase: () => ({ key: 'common:fieldValidationError.string.uppercase' }),
    matches: ({ regex }) => ({
      key: 'common:fieldValidationError.string.matches',
      values: { regex },
    }),
  ...
  number: {
    max: ({ max }) => ({
      key: 'common:fieldValidationError.number.max',
      values: { max },
    }),
    min: ({ min }) => ({
      key: 'common:fieldValidationError.number.min',
      values: { min },
    }),
    ...
    lessThan: ({ less }) => ({
      key: 'common:fieldValidationError.number.lessThan',
      values: { less },
    }),
    moreThan: ({ more }) => ({
      key: 'common:fieldValidationError.number.moreThan',
      values: { more },
    }),
  },
});
