...
func NewUnauthorizedError(msg string, options ...GenericErrorOption) Error {
	return NewUnauthorizedErrorWithOptions(append([]GenericErrorOption{WithErrorMessage(msg)}, options...)...)
}

func NewUnauthorizedErrorWithError(err error, options ...GenericErrorOption) Error {
	return NewUnauthorizedErrorWithOptions(append([]GenericErrorOption{WithError(err)}, options...)...)
}
