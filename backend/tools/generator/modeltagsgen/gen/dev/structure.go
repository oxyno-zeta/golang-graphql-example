...
//go:generate go run github.com/oxyno-zeta/golang-graphql-example/tools/generator/modeltagsgen github.com/oxyno-zeta/golang-graphql-example/tools/generator/modeltags/gen/dev Dev1
type Dev1 struct {
	database.Base
